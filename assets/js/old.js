;(function () {
  ...
  function sortAssignments (students) {
    ...
    actualStudents.forEach( student => {
      ...
      student.assignmentGroups = {};     
      
      student.assignments.forEach( assignment => {
        
        if (student.assignmentGroups[assignment.status]) {
          student.assignmentGroups[assignment.status].push(assignment);
        } else {
          student.assignmentGroups[assignment.status] = [assignment];
        }
